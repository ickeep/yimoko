...
export const PickerMulti = (props: PickerMultiProps) => {
  ...
  const [curIndexes, setCurIndexes] = useState<any[]>([]);
  ...
  return (
    <PickerWp onChange={onChange} value={curLabel} clearable={clearable} >
      <TPicker className='y-picker' rangeKey="label" mode="multiSelector" value={curIndexes} range={curColumns}
        // eslint-disable-next-line complexity
        onColumnChange={(e) => {
