...
const cdn = {
  ...
  devJS: [
    ...
    'https://cdn.jsdelivr.net/npm/@formily/path@2.1.11/dist/formily.path.umd.development.js',
    'https://cdn.jsdelivr.net/npm/@formily/path@2.1.11/dist/formily.path.umd.development.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/shared@2.1.11/dist/formily.shared.umd.development.js',
    'https://cdn.jsdelivr.net/npm/@formily/shared@2.1.11/dist/formily.shared.umd.development.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/reactive@2.1.11/dist/formily.reactive.umd.development.js',
    'https://cdn.jsdelivr.net/npm/@formily/reactive@2.1.11/dist/formily.reactive.umd.development.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/validator@2.1.11/dist/formily.validator.umd.development.js',
    'https://cdn.jsdelivr.net/npm/@formily/validator@2.1.11/dist/formily.validator.umd.development.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/core@2.1.11/dist/formily.core.umd.development.js',
    'https://cdn.jsdelivr.net/npm/@formily/core@2.1.11/dist/formily.core.umd.development.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/reactive-react@2.1.11/dist/formily.reactive-react.umd.development.js',
    'https://cdn.jsdelivr.net/npm/@formily/reactive-react@2.1.11/dist/formily.reactive-react.umd.development.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/react@2.1.11/dist/formily.react.umd.development.js',
    'https://cdn.jsdelivr.net/npm/@formily/react@2.1.11/dist/formily.react.umd.development.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/json-schema@2.1.11/dist/formily.json-schema.umd.development.js',
    'https://cdn.jsdelivr.net/npm/@formily/json-schema@2.1.11/dist/formily.json-schema.umd.development.js.map',

    'https://cdn.jsdelivr.net/npm/@ant-design/icons@4.7.0/dist/index.umd.js',

    'https://cdn.jsdelivr.net/npm/@formily/antd@2.1.11/dist/formily.antd.umd.development.js',
    'https://cdn.jsdelivr.net/npm/@formily/antd@2.1.11/dist/formily.antd.umd.development.js.map',
  ],
  ...
  prodJS: [
    ...
    'https://cdn.jsdelivr.net/npm/@formily/path@2.1.11/dist/formily.path.umd.production.js',
    'https://cdn.jsdelivr.net/npm/@formily/path@2.1.11/dist/formily.path.umd.production.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/shared@2.1.11/dist/formily.shared.umd.production.js',
    'https://cdn.jsdelivr.net/npm/@formily/shared@2.1.11/dist/formily.shared.umd.production.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/reactive@2.1.11/dist/formily.reactive.umd.production.js',
    'https://cdn.jsdelivr.net/npm/@formily/reactive@2.1.11/dist/formily.reactive.umd.production.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/validator@2.1.11/dist/formily.validator.umd.production.js',
    'https://cdn.jsdelivr.net/npm/@formily/validator@2.1.11/dist/formily.validator.umd.production.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/core@2.1.11/dist/formily.core.umd.production.js',
    'https://cdn.jsdelivr.net/npm/@formily/core@2.1.11/dist/formily.core.umd.production.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/reactive-react@2.1.11/dist/formily.reactive-react.umd.production.js',
    'https://cdn.jsdelivr.net/npm/@formily/reactive-react@2.1.11/dist/formily.reactive-react.umd.production.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/react@2.1.11/dist/formily.react.umd.production.js',
    'https://cdn.jsdelivr.net/npm/@formily/react@2.1.11/dist/formily.react.umd.production.js.map',

    'https://cdn.jsdelivr.net/npm/@formily/json-schema@2.1.11/dist/formily.json-schema.umd.production.js',
    'https://cdn.jsdelivr.net/npm/@formily/json-schema@2.1.11/dist/formily.json-schema.umd.production.js.map',

    'https://cdn.jsdelivr.net/npm/@ant-design/icons@4.7.0/dist/index.umd.min.js',

    'https://cdn.jsdelivr.net/npm/@formily/antd@2.1.11/dist/formily.antd.umd.production.js',
    'https://cdn.jsdelivr.net/npm/@formily/antd@2.1.11/dist/formily.antd.umd.production.js.map',
  ],
};
